...
import { basket,warning,checkicon,next,pasport,camera,selfi,profile_icon, location_map, search } from '../../assets/icons'
...
const Email = ({onpress})=>(//Привязать EMAIL
...
const Slide2=({onpress})=>(//ПРЕДУПРЕЖДЕНИЕ
    <View style={styles.container}>
...
const Slide3 = ({onpress})=>(//СОЗДАНИЕ ПАРОЛЯ
    <View style={styles.container}>
...
const Slide4 = ({onpress})=>(//ВЫБОР ГОРОДА
    <View style={styles.container}>
...
const Slide5 = ({onpress})=>( //ЛИЧНЫЕ ДАННЫЕ
...
const Slide6 = ({changeMounth,visible,onpress,closeModal})=>(//ЛИЧНЫЕ ДАННЫЕ
    <View style={{flex: 1}}>
        <Header text='ЛИЧНЫЕ ДАННЫЕ' />
        <Text style={{
            marginLeft: '10%',
...
const Slider7= ({onpress})=>(//МОИ Навыки
    <View style={styles.container}>
...
<View>
        ...
        <YellowBtn text='Далее' onPress={onpress} />
        </View>
)
const Slider8= ({onpress,check,takePhotoPasport,shotPhotoPassport})=>(//УДОСТОВЕРЕНИЕ
    <View style={styles.container}>
        <Header text='УДОСТОВЕРЕНИЕ' />
        {check?
        <Check text={`Фото вашего удостоверения \nуспешно загружено`} onpress={onpress} />
...
const Slider9= ({onpress,check})=>(//СЕЛФИ
    <View style={styles.container}>
        <Header text='СЕЛФИ' />
        { check? 
...
const Slider11= ({onpress})=>(//СЕРТИФИКАТЫ
    <View style={styles.container}>
        ...
        <Text style={{
         ...
         <View style={{width:'110%',marginLeft: '-3%'}}>
         <YellowBtn text='Загрузить' onPress={onpress}/>
         </View>
         </View>
    </View>
)
const Slider12 = ({onpress,check})=>(//Аватар профиля
    <View style={styles.container}>
        <Header text='Аватар профиля' />
        {check?
        <Check text={`success`} onpress={onpress}/>
        :<View>
        <Text style={{
            marginLeft: '10%',
            marginTop: '5%',
...
const Slider13 = ({onpress, start, value})=>(//Пользовательское соглашение
    <View style={styles.container}>
        <ScrollView>
        <Text style={{
            marginHorizontal: '10%',
        ...
        <View style={[styles.container,{backgroundColor: '#fff'}]}>
            {
                ...
                <Slide3 onpress={()=>{this.changeIndex(2)}}/>
                <Slide4 onpress={()=>{this.changeIndex(1)}}/>
                <Slide5 onpress={()=>{this.changeIndex(1)}}/>
                <Slide6 
                    onpress={()=>{this.changeIndex(1)}} 
                    visible={this.state.visible} 
                    changeMounth={()=>{this.setState({visible: true})}}
                    closeModal={()=>{this.setState({visible: false})}}/>
                <Email onpress={()=>{this.changeIndex(1)}}/>
                <Slider7 onpress={()=>{this.changeIndex(1)}} />
                <Slider8 
                    onpress={()=>{this.changeIndex(1)}} 
                    takePhotoPasport={()=>{this.takePhotoPasport()}}
                    shotPhotoPassport={()=>{this.shotPhotoPassport()}}
                    />
                <Slider9 onpress={()=>{this.changeIndex(1)}} check/>
                <Slider10 onpress={()=>{this.changeIndex(1)}} />
                <Slider11 onpress={()=>{this.changeIndex(1)}} />
                <Slider12 onpress={()=>{this.changeIndex(1)}} check/>
                <Slider13 
                onpress={()=>{this.changeIndex(1)}}
                    start={()=>{
                    this.setState({
                ...
                <CodeInputSlider onpress={()=>this.props.navigation.navigate('InstMain')} />
            </Swiper>
                :<Slide2 onpress={()=>{
                    this.setState({
                        agree: true
