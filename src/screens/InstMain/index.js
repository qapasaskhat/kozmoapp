          ...
          <ScrollView>
            ...
            <View style={styles.card}>
              <View style={styles.imgAva} >
                <Image source={avatar} style={{resizeMode:'cover',width:'100%',height:'100%',borderRadius:9}}/>
              </View>
            ...
            <InstCategory items={this.state.skills} add={()=>{navigation.navigate('Skills')}}/>
            <MoneyCard onPress={()=>{navigation.navigate('Withdraw')}} />
            <TouchableOpacity
            ...
            <Myphotos onPress={()=>navigation.navigate('Photo')} />
            <View
              style={{
                marginHorizontal: '10%',
                marginTop: '10%',
            ...
            <View
              ...
              <Text
                ...
                Биография тренера,дополнительная информация. Вы будете
                заряжаться хорошим настроением на протяжении всей тренировки
              </Text>
            </View>
